...
public class Weight3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.weight3_screen);
        btn_play = (Button) findViewById(R.id.btn_jogar);
        sk_weight = (SeekBar) findViewById(R.id.sk_weight3);

        sk_weight.setMax(1300);
        ...
        btn_play.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(getBaseContext(), PlayWeight3Activity.class);
