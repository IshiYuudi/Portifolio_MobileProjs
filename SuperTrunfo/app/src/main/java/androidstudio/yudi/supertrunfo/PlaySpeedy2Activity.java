...
public class PlaySpeedy2Activity extends AppCompatActivity {
    private TextView tv_valor;
    private ImageView iv_computer;
    private TextView tv_speedy_computer;
    private static int TEMPO = 6000;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.playspeedy2_screen);
        tv_valor = (TextView) findViewById(R.id.tv_valor);
        iv_computer = (ImageView) findViewById(R.id.iv_computer);
        tv_speedy_computer = (TextView) findViewById(R.id.tv_speedy_computer);
        //
        Intent i = getIntent();
        ...
        int escolhaComputador = (int) (Math.random()*200)+1;
        ...
        tv_speedy_computer.setText(Integer.toString(escolhaComputador));
