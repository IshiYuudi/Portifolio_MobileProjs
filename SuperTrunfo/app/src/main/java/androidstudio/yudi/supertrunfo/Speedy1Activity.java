...
public class Speedy1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.speedy1_screen);
        btn_play = (Button) findViewById(R.id.btn_jogar);
        sk_speedy = (SeekBar) findViewById(R.id.sk_speedy1);

        sk_speedy.setMax(100);
        ...
        btn_play.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(getBaseContext(), PlaySpeedyActivity.class);
