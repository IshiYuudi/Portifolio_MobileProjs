...
public class Speedy2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.speedy2_screen);
        btn_play = (Button) findViewById(R.id.btn_jogar);
        sk_speedy = (SeekBar) findViewById(R.id.sk_speedy2);

        sk_speedy.setMax(200);
        ...
        btn_play.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(getBaseContext(), PlaySpeedy2Activity.class);
