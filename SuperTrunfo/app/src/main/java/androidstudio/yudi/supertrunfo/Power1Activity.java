...
public class Power1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.power1_screen);
        btn_play = (Button) findViewById(R.id.btn_jogar);
        sk_power = (SeekBar) findViewById(R.id.sk_power1);
        ...
        btn_play.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(getBaseContext(), PlayPowerActivity.class);
