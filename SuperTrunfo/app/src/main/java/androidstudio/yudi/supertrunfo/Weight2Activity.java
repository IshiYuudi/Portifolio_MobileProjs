...
public class Weight2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.weight2_screen);
        btn_play = (Button) findViewById(R.id.btn_jogar);
        sk_weight = (SeekBar) findViewById(R.id.sk_weight2);

        sk_weight.setMax(1500);
        ...
        btn_play.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(getBaseContext(), PlayWeight2Activity.class);
