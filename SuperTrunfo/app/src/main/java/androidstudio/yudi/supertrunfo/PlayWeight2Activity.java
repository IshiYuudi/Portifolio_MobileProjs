...
public class PlayWeight2Activity extends AppCompatActivity {
    private TextView tv_valor;
    private ImageView iv_computer;
    private TextView tv_weight_computer;
    private static int TIMER = 6000;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.playweight2_screen);
        ...
        int escolhaComputador = (int) (Math.random()*1500)+1;
        ...
        tv_weight_computer.setText(Integer.toString(escolhaComputador));
