...
public class Power2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.power2_screen);
        btn_play = (Button) findViewById(R.id.btn_jogar);
        sk_power = (SeekBar) findViewById(R.id.sk_power2);
        ...
        btn_play.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(getBaseContext(), PlayPower2Activity.class);
